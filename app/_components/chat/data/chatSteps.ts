...
import { validateByStep } from '../utils/chatValidator';
...
export const chatSteps: ChatStep[] = [
  {
    ...
    validation: (value: string) => validateByStep(0, value).isValid,
  ...
  },
  {
    ...
    validation: (value: string) => validateByStep(5, value).isValid,
  ...
  },
  {
    ...
    validation: (value: string) => validateByStep(7, value).isValid,
  ...
  },
  {
    ...
    validation: (value: string) => validateByStep(9, value).isValid,
